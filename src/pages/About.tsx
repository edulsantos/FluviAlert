...
const About: React.FC = () => {
  const team = [
    ...
    { name: 'Pietro Bolzan',    role: 'Membro do Projeto', image: '/team/pietro_v2.jpg',  position: 'object-right'  },
  ]
    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-right-4 duration-700">
      ...
      <div className="grid grid-cols-12 gap-12 items-center">
        <div className="col-span-7 space-y-6">
          ...
          <div className="space-y-4 text-brand-muted text-lg font-medium leading-relaxed max-w-xl">
            <p>
