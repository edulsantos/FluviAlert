    ...
    <div className="space-y-12 animate-in fade-in slide-in-from-right-4 duration-700">
      ...
      <div className="pt-10">
        <div className="flex items-center gap-4 mb-4">
          <h3 className="text-2xl font-bold text-white tracking-tight underline decoration-brand-cyan decoration-3 underline-offset-8">
            Como Funciona
          </h3>
        </div>
          ...
          {pipelineSteps.map((step, i) => (
            <Card key={i} className="group relative p-6 hover:-translate-y-2 transition-all border-brand-border/30 hover:border-brand-primary/40 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-sm font-bold text-white uppercase tracking-wide mb-2">{step.title}</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-brand-muted leading-relaxed">
                    É o <span className="text-white font-semibold">volume de água que passa no rio</span> por segundo (m³/s). 
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-brand-muted leading-relaxed">
                    A precipitação mede apenas a <span className="text-white font-semibold">chuva local</span> em milímetros. 
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h4 className="text-base font-bold text-white">Thresholds por Bacia Hidrográfica</h4>
        ...
        <Card className="p-5 mb-6 border-brand-border/30 bg-brand-sidebar/30">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              <p className="text-xs font-semibold text-white uppercase tracking-wider">Nota sobre precisão</p>
              <p className="text-sm text-brand-muted leading-relaxed">
                As previsões são geradas pelo modelo global GloFAS/ECMWF com resolução de ~10 km. 
                Esses dados servem como <span className="text-white font-semibold">indicativo de tendência</span> e não substituem 
      ...
      <div className="pt-10">
        <div className="flex items-center gap-4 mb-8">
          <h3 className="text-2xl font-bold text-white tracking-tight underline decoration-brand-primary decoration-3 underline-offset-8">Corpo Técnico</h3>
        </div>
